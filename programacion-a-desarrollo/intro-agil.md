...
Esta forma de trabajar está estrechamente vinculada a la idea de _ciclo de vida_ descripta en una [sección anterior](./ciclo-de-vida).  
...
Para no hacer demasiado largo este material, realizamos un pequeño pantallazo histórico de la concepción ágil en [una página separada](./historia-agil).
